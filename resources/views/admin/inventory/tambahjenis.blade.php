...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <form class="" method="POST" action="{{ route('jenisbarang.tambah') }}">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="jenis">Jenis Barang</label>
                            <input type="text" id="jenis"  class="form-control{{ $errors->has('jenis') ? ' is-invalid' : '' }}" name="jenis" value="{{ old('jenis') }}" placeholder="Masukkan jenis barang" >
                            @if ($errors->has('jenis'))
                    ...
                    <div class="modal-footer">
                        <input type="submit" class="btn btn-primary" value="Tambah Jenis Barang">
                    </div>
                </form>
            </div>
